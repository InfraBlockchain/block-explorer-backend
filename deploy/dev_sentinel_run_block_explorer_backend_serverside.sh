...
#sudo nohup bin/block-explorer-backend -Dconfig.resource=application.dev.sentinel.conf -Dlogger.resource=logback.dev.sentinel.xml -Dhttp.port=80 -J-Xmx1024m -J-Xms1024m -J-server > /mnt/block-explorer-backend_nohup.out 2>&1&
