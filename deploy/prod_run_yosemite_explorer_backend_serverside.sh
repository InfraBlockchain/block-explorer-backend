...
#sudo nohup bin/yosemite-explorer-backend -Dconfig.resource=application.prod.conf -Dlogger.resource=logback.prod.xml -Dhttp.port=80 -J-Xmx1024m -J-Xms1024m -J-server > /mnt/yosemite-explorer-backend_nohup.out 2>&1&
