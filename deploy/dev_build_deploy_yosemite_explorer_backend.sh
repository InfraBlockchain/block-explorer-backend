#!/bin/bash
# chmod +x dev_build_deploy_yosemite_explorer_backend.sh
...
RUN_PLAY_APP_SERVERSIDE_SCRIPT="${PLAY_BASE_PATH}/deploy/dev_run_yosemite_explorer_backend_serverside.sh"
...
SERVER_ADDRESS="testnet-explorer-api.yosemitelabs.org"
