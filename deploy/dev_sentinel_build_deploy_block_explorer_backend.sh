#!/bin/bash
# chmod +x dev_sentinel_build_deploy_block_explorer_backend.sh
...
RUN_PLAY_APP_SERVERSIDE_SCRIPT="${PLAY_BASE_PATH}/deploy/dev_sentinel_run_block_explorer_backend_serverside.sh"
