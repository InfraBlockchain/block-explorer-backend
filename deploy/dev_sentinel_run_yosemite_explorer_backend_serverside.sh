...
PLAY_APP_CONFIG_FILE="application.dev.sentinel.conf"
PLAY_APP_LOGGER_FILE="logback.dev.sentinel.xml"
...
#sudo nohup bin/yosemite-explorer-backend -Dconfig.resource=application.dev.sentinel.conf -Dlogger.resource=logback.dev.sentinel.xml -Dhttp.port=80 -J-Xmx1024m -J-Xms1024m -J-server > /mnt/yosemite-explorer-backend_nohup.out 2>&1&
